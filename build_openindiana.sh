#!/bin/sh
#
# This has been tested on OpenIndiana, but it should also work on other Solaris flavours.
# This will not build on Sparc hardware.
...
[ "$(uname -s)" = SunOS ] && [ "$(isainfo -k)" = amd64 ] &&  extra_flags="$extra_flags -DUI_SSE2"
